...
function(copy_qt_binaries DESTINATION IS_APP)
    ...
    set(IMAGE_FORMATS qgif qicns qico qjpeg qsvg qtga qtiff qwbmp qwebp)

    foreach(image_format IN LISTS IMAGE_FORMATS)
        configure_file("${QT_PLUGINS_DIR}/imageformats/${image_format}${SUFFIX}.dll" "${DESTINATION}/imageformats/" COPYONLY)
    endforeach()
endfunction()