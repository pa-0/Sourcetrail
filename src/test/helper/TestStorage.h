...
class TestStorage {
public:
  static std::shared_ptr<TestStorage> create(const std::shared_ptr<const Storage>& storage) {
...
private:
  ...
  static bool containsLocation(const StorageSourceLocation& outLocation, const StorageSourceLocation& inLocation) {
