...
TEST(SettingsMigrator, migratorChangesNothingWithoutMigrationsExceptVersion) {
  ...
  EXPECT_TRUE(settingsBefore.getAsText() == settingsAfter.getAsText());
}

TEST(SettingsMigrator, migratorChangesName) {
  MigratorTestSettings settingsBefore = createSettings(
      "<?xml version=\"1.0\" encoding=\"utf-8\" ?>\n"
      "<config>\n"
      "    <value>2</value>\n"
...
TEST(SettingsMigrator, migratorChangesPath) {
  MigratorTestSettings settingsBefore = createSettings(
      "<?xml version=\"1.0\" encoding=\"utf-8\" ?>\n"
      "<config>\n"
      "    <value>2</value>\n"
...
TEST(SettingsMigrator, migratorChangesGroupName) {
  MigratorTestSettings settingsBefore = createSettings(
      "<?xml version=\"1.0\" encoding=\"utf-8\" ?>\n"
      "<config>\n"
      "    <values>\n"
...
TEST(SettingsMigrator, migratorChangesGroupElementName) {
  MigratorTestSettings settingsBefore = createSettings(
      "<?xml version=\"1.0\" encoding=\"utf-8\" ?>\n"
      "<config>\n"
      "    <values>\n"
...
TEST(SettingsMigrator, migratorChangesOnlyUpSpecifiedVersion) {
  MigratorTestSettings settingsBefore = createSettings(
      "<?xml version=\"1.0\" encoding=\"utf-8\" ?>\n"
      "<config>\n"
      "    <value>2</value>\n"
...
TEST(SettingsMigrator, migratorChangesOnlyFromSpecifiedVersion) {
  MigratorTestSettings settingsBefore = createSettings(
      "<?xml version=\"1.0\" encoding=\"utf-8\" ?>\n"
      "<config>\n"
      "    <int>2</int>\n"
...
TEST(SettingsMigrator, migratorChangesForMultipleVersions) {
  MigratorTestSettings settingsBefore = createSettings(
      "<?xml version=\"1.0\" encoding=\"utf-8\" ?>\n"
      "<config>\n"
      "    <value>2</value>\n"
...
TEST(SettingsMigrator, migratorChangesForMultipleMigrations) {
  MigratorTestSettings settingsBefore = createSettings(
      "<?xml version=\"1.0\" encoding=\"utf-8\" ?>\n"
      "<config>\n"
      "    <value>2</value>\n"
...
TEST(SettingsMigrator, migratorChangesForMultipleVersionsAndMigrations) {
  MigratorTestSettings settingsBefore = createSettings(
      "<?xml version=\"1.0\" encoding=\"utf-8\" ?>\n"
      "<config>\n"
      "    <value>2</value>\n"
...
TEST(SettingsMigrator, migratorWithLambda) {
  MigratorTestSettings settingsBefore = createSettings(
      "<?xml version=\"1.0\" encoding=\"utf-8\" ?>\n"
      "<config>\n"
      "    <value>2</value>\n"
  ...
  SettingsMigrator migrator;
  migrator.addMigration(1, std::make_shared<SettingsMigrationLambda>([](const SettingsMigration* migration, Settings* settings) {
...
TEST(SettingsMigrator, migratorWithMultipleLambdas) {
  MigratorTestSettings settingsBefore = createSettings(
      "<?xml version=\"1.0\" encoding=\"utf-8\" ?>\n"
      "<config>\n"
      "    <value>2</value>\n"
  ...
  migrator.addMigration(2, std::make_shared<SettingsMigrationLambda>([](const SettingsMigration* migration, Settings* settings) {
                          migration->setValueInSettings<int>(
