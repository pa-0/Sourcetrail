...
public:
  explicit PreprocessorCallbacks(clang::SourceManager& sourceManager,
  ...
  void Defined(const clang::Token& macroNameToken, const clang::MacroDefinition& macroDefinition, clang::SourceRange range) override;
