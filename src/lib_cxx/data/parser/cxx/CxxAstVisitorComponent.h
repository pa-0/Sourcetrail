...
#define DEF_TRAVERSE_CUSTOM_TYPE_PTR(__NAME_TYPE__, __PARAM_TYPE__)                                                              \
  void beginTraverse##__NAME_TYPE__([[maybe_unused]] clang::__PARAM_TYPE__* v) {}                                                \
  void endTraverse##__NAME_TYPE__([[maybe_unused]] clang::__PARAM_TYPE__* v) {}

#define DEF_TRAVERSE_CUSTOM_TYPE(__NAME_TYPE__, __PARAM_TYPE__)                                                                  \
  void beginTraverse##__NAME_TYPE__([[maybe_unused]] const clang::__PARAM_TYPE__& v) {}                                          \
  void endTraverse##__NAME_TYPE__([[maybe_unused]] const clang::__PARAM_TYPE__& v) {}
