...
public:
  CxxAstVisitor(clang::ASTContext* astContext,
  ...
  virtual bool TraverseLambdaCapture(clang::LambdaExpr* lambdaExpr,
...
protected:
  using Base = clang::RecursiveASTVisitor<CxxAstVisitor>;
