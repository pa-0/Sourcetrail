...
QtScreenSearchBox::QtScreenSearchBox(ControllerProxy<ScreenSearchController>* controllerProxy, QWidget* parent)
  ...
  createMatchButton(layout);
  createPrevNextButton(layout);
  createFilterLayout(layout);
  createCloseButton(layout);
  createTimer();
...
void QtScreenSearchBox::createPrevNextButton(QHBoxLayout* layout) {
  m_prevButton = new QtSelfRefreshIconButton(QLatin1String(""),
...
void QtScreenSearchBox::createFilterLayout(QHBoxLayout* layout) {
  m_checkboxLayout = new QHBoxLayout();
  layout->addLayout(m_checkboxLayout);
  layout->addStretch();
}

void QtScreenSearchBox::createCloseButton(QHBoxLayout* layout) {
