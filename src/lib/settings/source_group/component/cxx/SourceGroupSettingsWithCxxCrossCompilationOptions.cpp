...
std::vector<std::wstring> SourceGroupSettingsWithCxxCrossCompilationOptions::getAvailableArchTypes() {
  ...
  return {
      L"aarch64",        L"aarch64_be",     L"aarch64_32", L"arm",     L"armeb",   L"arc",      L"avr",     L"bpfel",
      L"bpfeb",          L"hexagon",        L"mips",       L"mipsel",  L"mips64",  L"mips64el", L"msp430",  L"powerpc64",
      L"powerpc64le",    L"powerpc",        L"r600",       L"amdgcn",  L"riscv32", L"riscv64",  L"sparc",   L"sparcv9",
      L"sparcel",        L"s390x",          L"tce",        L"tcele",   L"thumb",   L"thumbeb",  L"i386",    L"x86_64",
      L"xcore",          L"nvptx",          L"nvptx64",    L"le32",    L"le64",    L"amdil",    L"amdil64", L"hsail",
      L"hsail64",        L"spir",           L"spir64",     L"kalimba", L"lanai",   L"shave",    L"wasm32",  L"wasm64",
      L"renderscript32", L"renderscript64",
  };
}
