...
#  define LOG_INFO_W(__str__)                                                                                                    \
    spdlog::info(L"{} {}:{} {}", utility::decodeFromUtf8(__FILE__), utility::decodeFromUtf8(__FUNCTION__), __LINE__, __str__);
#else
...
#  define LOG_WARNING_W(__str__)                                                                                                 \
    spdlog::warn(L"{} {}:{} {}", utility::decodeFromUtf8(__FILE__), utility::decodeFromUtf8(__FUNCTION__), __LINE__, __str__);
#else
...
#  define LOG_ERROR_W(__str__)                                                                                                   \
    spdlog::error(L"{} {}:{} {}", utility::decodeFromUtf8(__FILE__), utility::decodeFromUtf8(__FUNCTION__), __LINE__, __str__);
#else
