...
#define DEF_GETTER_5(                                                                                                              \
    _METHOD_NAME_, _PARAM_1_TYPE_, _PARAM_2_TYPE_, _PARAM_3_TYPE_, _PARAM_4_TYPE_, _PARAM_5_TYPE_, _RETURN_TYPE_, _DEFAULT_VALUE_) \
  UNWRAP(_RETURN_TYPE_)                                                                                                            \
  StorageAccessProxy::_METHOD_NAME_(                                                                                               \
      _PARAM_1_TYPE_ p1, _PARAM_2_TYPE_ p2, _PARAM_3_TYPE_ p3, _PARAM_4_TYPE_ p4, _PARAM_5_TYPE_ p5) const {                       \
    if(std::shared_ptr<StorageAccess> subject = m_subject.lock()) {                                                                \
...
#define DEF_GETTER_6(_METHOD_NAME_,                                                                                              \
  ...
  UNWRAP(_RETURN_TYPE_)                                                                                                          \
  StorageAccessProxy::_METHOD_NAME_(                                                                                             \
      _PARAM_1_TYPE_ p1, _PARAM_2_TYPE_ p2, _PARAM_3_TYPE_ p3, _PARAM_4_TYPE_ p4, _PARAM_5_TYPE_ p5, _PARAM_6_TYPE_ p6) const {  \
    if(std::shared_ptr<StorageAccess> subject = m_subject.lock()) {                                                              \
...
DEF_GETTER_7(
    getGraphForTrail, Id, Id, NodeKindMask, Edge::TypeMask, bool, size_t, bool, std::shared_ptr<Graph>, std::make_shared<Graph>())
